...
async function start4(url9) {
  ...
  if (amazon) {
    ...
    let amazonenc = encodename.split("(")[0].trim();
    ...
    url2 =
      "https://www.amazon.in/s?k=" + amazonenc + "&ref=nb_sb_ss_ts-doa-p_2_7";
...
async function start6(url9) {
  ...
  if (reliance) {
    ...
    console.log(prodn4);
    console.log(price4);
    url4 = `https://www.reliancedigital.in/search?q=${relianceenc}:relevance:price:[${parseInt(
      cprice / 2
    )}%20TO%20${parseInt(cprice * 1.5)}]&page=0`;
